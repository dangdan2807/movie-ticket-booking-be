...
namespace MovieTicketBookingBe.Services
{
    public interface IShortUrlService
    {
        ...
        Task<GetShortUrlsDTO> GetShortUrlsForUserId(int userId, PaginationVM paginationVM, string? keyword = "", DateTime? startDate = null, DateTime? endDate = null, bool? status = true);
